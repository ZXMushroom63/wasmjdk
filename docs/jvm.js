...
var SYSCALLS = {
  ...
  writeStatFs(buf, stats) {
    ...
    (growMemViews(), HEAP32)[(((buf) + (60)) >> 2)] = stats.bsize;
    ...
    (growMemViews(), HEAP32)[(((buf) + (48)) >> 2)] = stats.fsid;
    (growMemViews(), HEAP32)[(((buf) + (64)) >> 2)] = stats.flags;
    // ST_NOSUID
    (growMemViews(), HEAP32)[(((buf) + (56)) >> 2)] = stats.namelen;
  },
...
function ___syscall_fchownat(dirfd, path, owner, group, flags) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(10, 0, 1, dirfd, path, owner, group, flags);
  try {
    path = SYSCALLS.getStr(path);
...
function ___syscall_statfs64(path, size, buf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 0, 1, path, size, buf);
  try {
    assert(size === 88);
...
function _fd_fdstat_get(fd, pbuf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(36, 0, 1, fd, pbuf);
  try {
    var rightsBase = 0;
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_accept4, ___syscall_bind, ___syscall_chdir, ___syscall_chmod, ___syscall_faccessat, ___syscall_fallocate, ___syscall_fchdir, ___syscall_fchownat, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_getsockopt, ___syscall_ioctl, ___syscall_listen, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_poll, ___syscall_readlinkat, ___syscall_renameat, ___syscall_rmdir, ___syscall_socket, ___syscall_stat64, ___syscall_statfs64, ___syscall_unlinkat, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write ];
